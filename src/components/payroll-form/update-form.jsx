...
export default class Update extends React.Component {
    ...
    // we want state to be updated which will be object we want to have and want to pass for usestate
    componentDidMount() {
   ...
   // method will be called when submit button click, it will call put method to call to 
    Update = async (event) => {
